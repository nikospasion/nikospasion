/* Shaders for the portrait reveal: a noise-warped cursor-trail
   buffer + a display pass that crossfades style textures and melts to the
   real photo through merged rounded-block SDFs where the trail is hot. */
